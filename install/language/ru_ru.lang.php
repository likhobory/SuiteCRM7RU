...
'ERR_DB_EXISTS_WITH_CONFIG'=> 'База данных уже существует. Чтобы установить систему с выбранной базой данных, перезапустите процесс установки и выберите параметр "Удалить и создать заново существующие таблицы SuiteCRM?". Для обновления системы используйте Мастер Обновлений в панели администратора. Более детальную информацию о процессе обновления вы можете почерпнуть в <a href="https://github.com/likhobory/SuiteCRM7RU" target="_new">Руководстве пользователя и администратора</a>.' ,
...
//'LBL_STEP3'                         => 'Шаг 3 из 8 - Выбор типа установки',
//'LBL_STEP4'                         => 'Шаг 4 из 8 - Выбор типа базы данных',
//'LBL_STEP5'                         => 'Шаг 5 из 8 - Настройка базы данных',
//'LBL_STEP6'                         => 'Шаг 6 из 8 - Настройка конфигурации сайта',
//'LBL_STEP7'                         => 'Шаг 7 из 8 - Подтверждение указанных параметров',
//'LBL_STEP8'                         => 'Шаг 8 из 8 - Установка успешно завершена',
...
'name' => 'Forgot Password email',
	...
	'STAT_CREATE_DB_TABLE' => 'Создание базы данных... (таблица: %s)',
