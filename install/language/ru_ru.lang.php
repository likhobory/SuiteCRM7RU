...
'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "Функции, необходимые для работы JSON-парсера не обнаружены. Вероятно, вам необходимо раскомментировать соответствующее расширение в файле php.ini, или перекомпилировать бинарный файл в соответствии с вашей версией PHP. Пожалуйста, обратитесь к руководству пользователя PHP за более подробной информацией.",
