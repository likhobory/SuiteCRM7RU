...
'ERR_DB_EXISTS_WITH_CONFIG' => 'База данных уже существует. Чтобы установить систему с выбранной базой данных, перезапустите процесс установки и выберите параметр "Удалить и создать заново существующие таблицы SuiteCRM?". Для обновления системы используйте Мастер Обновлений в панели администратора. Более детальную информацию о процессе обновления вы можете почерпнуть в <a href="https://suitecrm.com/suitecrm/forum/suitecrm-forum-russian-general-discussion/17907-suitecrm" target="_new">Руководстве пользователя и администратора</a>.' ,
