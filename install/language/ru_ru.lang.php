...
'ERR_DB_EXISTS_WITH_CONFIG' => 'База данных уже существует. Чтобы установить систему с выбранной базой данных, перезапустите процесс установки и выберите параметр "Удалить и создать заново существующие таблицы SuiteCRM?". Для обновления системы используйте Мастер Обновлений в панели администратора. Более детальную информацию о процессе обновления вы можете почерпнуть в <a href="https://github.com/likhobory/SuiteCRM7RU/raw/master/DOCS/Russian_Rapira_Application_Guide_for_SuiteCRM.pdf" target="_new">Руководстве пользователя и администратора</a>.' ,
