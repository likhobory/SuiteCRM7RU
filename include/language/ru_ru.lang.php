...
$app_strings = array(
  ...
  'LBL_COMPANY_LOGO' => 'Логотип', /*for 508 compliance fix*/
    ...
    'LBL_DISMISS_ALL_DRAFTS_CONFIRM' => 'Закрыть всё?',
...
$app_strings['LBL_NO_DOCUMENT_ID_PROVIDED'] = 'Не удалось найти документ для удаления редакции, идентификатор документа не указан.';
$app_strings['LBL_NO_RECORD_ID_PROVIDED'] = 'Не удалось найти редакцию документа для удаления, идентификатор записи не указан.';
