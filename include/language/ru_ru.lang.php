...
//       it is the key for the default record_type_module value
 ...
 'dom_email_errors' => array (      1 => 'Выбирайте только одного пользователя, когда напрямую работаете с назначенными записями.',
    ...
    'dom_editor_type' => array(        	'tinymce' => 'Tiny MCE',
										'mozaik' => 'Mozaik',
...
$app_strings = array (
  ...
  'LBL_ID_FF_OPT_OUT' => 'Не использовать этот электронный адрес',
  ...
  'LBL_JS_CALENDAR' => 'Календарь' /*for 508 compliance fix*/,
   ...
   'LBL_EMAIL_ADDRESS_BOOK_ADD'			    => 'Готово',
    ...
    'LBL_EMAIL_ERROR_SAVING' => 'Ошибка при сохранении письма. Свяжитесь с Администратором системы.',
    ...
    'LBL_EMAIL_DRAFT_CONFIRM_DISCARD' => 'Вы действительно хотите закрыть это сообщение?',
...
$app_strings['LBL_DETAIL_BUTTON_TITLE'] = 'Просмотр деталей';
