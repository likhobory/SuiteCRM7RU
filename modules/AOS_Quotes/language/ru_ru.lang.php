...
$mod_strings = array (
  ...
  'LBL_AOS_QUOTES_AOS_INVOICES' => 'Предложения : Счета', /// for PR #2698
  'LBL_AOS_LINE_ITEM_GROUPS' => 'Группы', /// for PR #2698
  'LBL_AOS_PRODUCTS_QUOTES' => 'Предложения-Товары', /// for PR #2698
  'LBL_AOS_QUOTES_PROJECT' => 'Предложения-Проекты', /// for PR #2698
  'LBL_SUBTOTAL_TAX_AMOUNT_USDOLLAR' => 'Итого учётом скидки и НДС (основная валюта)', /// for PR #2698
);
?>
