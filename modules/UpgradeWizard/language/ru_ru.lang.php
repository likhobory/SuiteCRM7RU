...
'LBL_UW_START_DESC2' => 'Настоятельно рекомендуем перед обновлением системы сделать резервные копии как базы данных, так и файлов SuiteCRM. <br>Как известно, профилактика - лучшее лечение. <br>Если файл "composer.json" был изменён, выполните команду <pre>composer update</pre> по окончании обновления.',
