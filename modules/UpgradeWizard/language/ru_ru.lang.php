...
'LBL_UW_SYSTEM_CHECK_CHECKING'=>'Идёт проверка, пожалуйста, подождите. Операция может занять некоторое время.',
...
'LBL_RECOMMENDED_PHP_VERSION' => '. Рекомендуемая версия: 5.2.2 или более новая)',
